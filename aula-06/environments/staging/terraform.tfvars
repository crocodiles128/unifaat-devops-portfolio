...
subnets = {
  "public-a"  = { cidr = "10.1.1.0/24", az = "us-east-1a", type = "public" }
  "public-b"  = { cidr = "10.1.2.0/24", az = "us-east-1b", type = "public" }
  "private-a" = { cidr = "10.1.3.0/24", az = "us-east-1a", type = "private" }
  "private-b" = { cidr = "10.1.4.0/24", az = "us-east-1b", type = "private" }
}
...
db_password = "TechnovaStaging12345"   # alfanumérica para evitar problemas con @ / " / etc.